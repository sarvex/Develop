...
DWORD Eject::GetDrivesDevInstByDeviceNumber(long DeviceNumber)
{
...
bool Eject::matchDevInstToUsbDevice(DWORD device, DWORD vid, DWORD pid)
{
...
void Eject::ejectDrive(TCHAR driveletter)
{
    TCHAR devicepath[16];
...
void Eject::usbEjectDevice(unsigned vid, unsigned pid)
{
    TCHAR devicepath[8];
    _tcscpy(devicepath, _T("\\\\.\\?:"));
